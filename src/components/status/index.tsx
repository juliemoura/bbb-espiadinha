    ...
    <Container>
      <Content>
        ...
        <DescriptionContainer>
          <Description title="Disponível" borderColor="#47D814" />
      ...
      <Content>
        ...
        <DescriptionContainer>
          <Description title="Indisponível" borderColor="#D81414" />
      ...
      <Content>
        ...
        <DescriptionContainer>
          <Description title="Na piscina" borderColor="#00D1FF" />
      ...
      <Content>
        ...
        <DescriptionContainer>
          <Description title="Na academia" borderColor="#FFE600" />
